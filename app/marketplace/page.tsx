                    ...
                    <div className="relative overflow-hidden border-b bg-muted/20">
                      {item.previewImages?.length ? (
                        <div className="grid gap-1 p-2">
                          {hasError({ index: 0 }) ? (
                            <div className="flex items-center justify-center gap-2 text-muted-foreground h-40 w-full rounded-xl object-cover">
                          ...
                          {item.previewImages.length > 1 ? (
                            <div className="grid grid-cols-3 gap-1">
                              {item.previewImages.slice(1, 4).map((src, index) => {
                                if (hasError({ index: index })) {
                                  return (
                                    <div className="flex h-full items-center justify-center gap-2 text-muted-foreground border rounded-xl p-1 object-cover">
                                      <ImageOff className="h-5 w-5" />
                                    </div>
                                  );
                                }
                                return (
                                  <Image
                                    ...
                                    onError={() =>
                                      setImgErrorById((prev) => ({ ...prev, [index]: true }))
                                    }
                                  />
                                );
                              })}
